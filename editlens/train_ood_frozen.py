...
Take an already-trained EditLens-Qwen3 model (search HF for "editlens qwen3 repro") as a *frozen* feature
...
def main():
    ...
    ap.add_argument("--model_name", default=os.environ.get("BASE_MODEL", ""),
                    help="Frozen EditLens-Qwen3 checkpoint. Search HuggingFace for the keywords 'editlens qwen3 repro' and pass it via --model_name or BASE_MODEL.")
